...
3. 분야 다양성 및 대중성 (이슈/혜택 균형 및 비인기글 배제 규칙):
   ...
   - CRITICAL: 대다수의 전 국민, 청년, 서민, 주부, 직장인 등이 직관적으로 관심을 가질 만한 주제 위주로 골라줘. 특정 소수 대상(예: 건설노동자 전용 혜택, 극소수 대상의 난임 심리상담 등)의 대중성과 조회수가 매우 낮은 비인기 마이너 주제는 키워드로 절대 선정하지 마세요.

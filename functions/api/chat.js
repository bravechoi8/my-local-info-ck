...
async function callGemini(apiKey, systemPrompt, userMessage, useSearch) {
  const url = `https://gateway.ai.cloudflare.com/v1/b6c1fc66bc8cd5a10f618d37d44969df/my-blog-gateway/google-ai-studio/v1beta/models/gemini-2.5-flash:generateContent?key=${apiKey}`;
